...
<h1 align="center">📶 ImpossibleLatency 📶</h1>
<p align="center">
<a href="https://jenkins.perfectdreams.net/job/ImpossibleLatency/"><img src="https://jenkins.perfectdreams.net/job/ImpossibleLatency/badge/icon"></a>
<a href="https://www.codacy.com/app/MrPowerGamerBR/ImpossibleLatency?utm_source=github.com&amp;utm_medium=referral&amp;utm_content=PerfectDreams/ImpossibleLatency&amp;utm_campaign=Badge_Grade"><img src="https://api.codacy.com/project/badge/Grade/4bcd6b41d3fd4c8c809b05cca7befb81"></a>
<a href="https://github.com/PerfectDreams/ImpossibleLatency/blob/master/LICENSE"><img src="https://img.shields.io/badge/license-AGPL%20v3-lightgray.svg"></a>
</p>
<p align="center">
<a href="https://github.com/PerfectDreams/ImpossibleLatency/watchers"><img src="https://img.shields.io/github/watchers/PerfectDreams/ImpossibleLatency.svg?style=social&label=Watch"></a>
<a href="https://github.com/PerfectDreams/ImpossibleLatency/stargazers"><img src="https://img.shields.io/github/stars/PerfectDreams/ImpossibleLatency.svg?style=social&label=Stars"></a>
</p>
<p align="center">"0ms de ping? No meu servidor? É mais provável do que você imagina."</p>
...
* Eu não irei dar suporte caso você queria usar o nosso projeto no seu servidor sem dar nada em troca para o PerfectDreams, lembre-se, a licença do projeto é [AGPL v3](https://github.com/PerfectDreams/ImpossibleLatency/blob/master/LICENSE), você é **obrigado a deixar todas as suas alterações no projeto públicas**!
...
7. Faça ```git clone https://github.com/PerfectDreams/ImpossibleLatency.git``` em alguma pasta no seu computador.
...
Nós utilizamos várias [dependências no código-fonte](https://github.com/PerfectDreams/ImpossibleLatency/blob/master/pom.xml) deste projeto, obrigado a todos os mantenedores das dependências! Sem vocês, talvez nosso projeto não iria existir (ou teria várias funcionalidades reduzidas ou talvez até inexistentes!)
